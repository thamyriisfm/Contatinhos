...
class EditedTextMasked(context: Context, attrs: AttributeSet) : AppCompatEditText(context, attrs) {
    ...
    private var onPhoneNumberValid: Testinho? = null
    ...
    fun setListener(listener: Testinho) {
        onPhoneNumberValid = listener
    }
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                when (digitsOnly.length) {
                    in 1..8 -> formattedNumber.append("+")
                        .append(digitsOnly.substring(0))
